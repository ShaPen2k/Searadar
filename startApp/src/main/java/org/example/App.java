...
public class App {
    public static void main(String[] args) {
        ...
        String mr231_3_TTM = "$RATTM,46,05.14,123.4,T,52.8,139.5,T,6.3,-96.6,N,b,L,,496256,A*7f";
        ...
        Mr231_3Converter converter2 = mr231_3.createConverter();
        List<SearadarStationMessage> searadarMessages2 = converter2.convert(mr231_3_TTM);
        searadarMessages2.forEach(System.out::println);
        searadarMessages2 = converter2.convert(mr231_3_RSD);
        searadarMessages2.forEach(System.out::println);
    }
}